export const Loading = () => {
    return (
      <div className="flex flex-col items-center justify-center py-10 text-info-content">
  ...
  export const LoadingSmall = () => {
    return (
      <div className="flex flex-col items-center justify-center py-1 md:py-2 text-info-content">
