...
const VetRegisterForm = ({ vet, getPage, currentPage, pageSize }) => {
    ...
    useEffect(() => {
        if (vet && Object.keys(vet).length > 0) {
            const { email, password, firstName, lastName, phoneNumber, speciality, licenseNumber } = vet;
                ...
                <div className="pb-5 text-center">
                    ...
                    <input
                        ...
                        {...register("licenseNumber", {
                            ...
                            maxLength: {
                                value: 50,
                                message: "Speciality cannot exceed 50 characters"
                            },
                        })}
                        placeholder="Speciality"
                    />
