  ...
  return (
    ...
    >
      ...
      <div className="flex items-center flex-col">
        <p className="font-bold lg:text-3xl md:text-2xl text-lg pb-2 text-info-content">
          Opps... Page Not Found!
        </p>
        <NavLink to={"/home"}>
          <p
            type="button"
            className="bg-transparent rounded-[5px] p-1 border-2 border-info-content hover:bg-info-content text-info-content hover:text-white transition duration-500 shadow-info-content shadow-md lg:text-base md:text-sm text-xs"
          >
