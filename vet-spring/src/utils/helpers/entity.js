...
export const postEntity = async (entityPath, payload, signal) => api.post(`${url}/${entityPath}`, payload, {signal});

export const uploadEntityImage = async (entityPath, data, signal) => api.post(`${url}/${entityPath}/upload`, data, {signal});

export const putEntity = async (entityPath, entityId, payload, signal) =>
    api.put(`${url}/${entityPath}/${entityId}`, payload, {signal});
