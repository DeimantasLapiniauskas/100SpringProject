    ...
    return (
      <div>
        ...
        <div className="relative w-full min-h-screen">
          ...
          <main className="relative z-10 h-screen flex md:flex-col-reverse lg:flex-row justify-center items-center gap-8">
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="w-[400px] bg-[rgb(151,160,241)] border border-[#97a0f1] p-3 rounded-box min-h-[500px] mx-6"
            >
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                {visible && error.length != 0 && (
                  <Error error={error} setVisible={setVisible} />
                )}

                <button
                  type="submit"
                  className="custom-black-btn mt-4 figma-headline-4"
                >
                  Log in
                </button>
              </div>
              ...
              <NavLink
                to="/register"
                className="figma-headline-4 underline text-center mt-2 block"
              >
                Register
              </NavLink>
            </form>
