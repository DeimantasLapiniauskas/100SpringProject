  ...
  return (
    <div className=" mt-4 bg-gradient-to-b  to-blue-300 min-h-screen  shadow-lg shadow-blue-300  ">
      <div className="relative">
        ...
        <span className={`absolute right-7 top-0 text-[10px] sm:txt-xs md:text-sm lg:text-base text-info-content ${
              post.postType === "Sale"
                ? `text-red-700`
                : post.postType === "Blog"
                ? `text-[#006666]`
      ...
      <div className="p-1 sm:p-2 md:p-3 lg:p-4">
        <div className="col-span-2">
          ...
          <p className="break-words py-3 ms:py-4 md:py-5 px-3 sm:px-6 md:px-12 lg:px-15 responsive-text-lg text-info-content">{post?.imageUrl ? <img src={post.imageUrl} alt="postImage" className="rounded-[10px] float-right h-[10rem] md:h-[12rem] lg:h-[15rem] w-full xs:w-1/2 md:w-2/5  mb-2 xs:mb-1 xs:ms-2 object-cover "/> : ""}{post.content}</p>
        </div>
      </div>
    </div>
  );
