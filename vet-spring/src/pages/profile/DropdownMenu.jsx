  ...
  return (
    ...
    <button className="btn bg-[#97a0f1] w-12" onClick={handleOpen}>
      ...
      <div className="w-full p-3 bg-[#97a0f1]">
        ...
        <NavLink to={"/pets"}>
          <p className="custom-purple-btn cursor-pointer figma-headline-4 !font-bold mb-1">Your Pets</p>
        </NavLink>
        {account && <NavLink to={"/appointments"}>
        <p className=" custom-purple-btn cursor-pointer figma-headline-4 !font-bold mb-1 text-center">Appointments history</p>
        </NavLink>}
        {account ? (
          <button
            type="button"
