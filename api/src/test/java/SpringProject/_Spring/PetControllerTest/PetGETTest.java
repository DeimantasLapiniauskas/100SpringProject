...
public class PetGETTest {
    ...
    void getPets_whenGetUser_thenRespond200() throws Exception{
        ...
        mockMvc.perform(get("/api/pets/"+ownerId))
                ...
                .andExpect(jsonPath("[0].breed").value("Cat"))
                .andExpect(jsonPath("[0].species").value("Bald"))
                ...
                .andExpect(jsonPath("[1].breed").value("Dog"))
                .andExpect(jsonPath("[1].species").value("HeckinFloofer"))
                //Can't check birthdate
