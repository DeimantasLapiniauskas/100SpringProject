...
public record ClientRequestDTO(
        ...
        @Length(min = 11, max = 50, message = "Your email is either too short or too long! Min is 11, max is 50 symbols")
        String email,
        ...
        @Length(min = 3, max = 100, message = "Your first name must be between 3 and 100 characters long!")
        @Pattern(regexp = "^[A-Za-z ]*$", message = "Your first name must only consist of letters and spaces!")
        String firstName,

        @NotNull(message = "Last name can not be null!")
        @Length(min = 3, max = 100, message = "Your last name must be between 3 and 100 characters long!")
        @Pattern(regexp = "^[A-Za-z ]*$", message = "Your last name must only consist of letters and spaces!")
        String lastName,
